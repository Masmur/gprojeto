...
namespace GerenciadorProjeto.Models
{
    ...
    partial void OnNomeChanged();
		...
		[Association(Name="Empresa_Colaborador", Storage="_Colaboradors", OtherKey="EmpresaId")]
		...
		[Association(Name="Empresa_Produto", Storage="_Produtos", OtherKey="EmpresaId")]
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnColaboradoIdChanging(long value);
    partial void OnColaboradoIdChanged();
    partial void OnEmpresaIdChanging(long value);
    partial void OnEmpresaIdChanged();
    partial void OnNomeChanging(string value);
    partial void OnNomeChanged();
		...
		[Column(Storage="_ColaboradoId", AutoSync=AutoSync.OnInsert, DbType="BigInt NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public long ColaboradoId
		{
			get
			{
				return this._ColaboradoId;
			}
			set
			{
				if ((this._ColaboradoId != value))
				{
					this.OnColaboradoIdChanging(value);
					this.SendPropertyChanging();
					this._ColaboradoId = value;
					this.SendPropertyChanged("ColaboradoId");
					this.OnColaboradoIdChanged();
				}
			}
		}
		...
		[Association(Name="Empresa_Colaborador", Storage="_Empresa", ThisKey="EmpresaId", IsForeignKey=true)]
    ...
    partial void OnDataChanged();
		...
		[Association(Name="Sprint_SprintBackLog", Storage="_SprintBackLogs", OtherKey="SprintId")]
		...
		[Association(Name="Produto_Sprint", Storage="_Produto", ThisKey="ProdutoId", IsForeignKey=true)]
    ...
    partial void OnEstimativaChanged();
		...
		[Association(Name="BacklogItem_SprintBackLog", Storage="_SprintBackLogs", OtherKey="BacklogItemId")]
		public EntitySet<SprintBackLog> SprintBackLogs
		{
			get
			{
		...
		[Association(Name="Produto_BacklogItem", Storage="_Produto", ThisKey="ProdutoId", IsForeignKey=true)]
		public Produto Produto
		{
			get
			{
    ...
    partial void OnBacklogItemIdChanged();
		...
		[Association(Name="BacklogItem_SprintBackLog", Storage="_BacklogItem", ThisKey="BacklogItemId", IsForeignKey=true)]
		...
		[Association(Name="Sprint_SprintBackLog", Storage="_Sprint", ThisKey="SprintId", IsForeignKey=true)]
    ...
    partial void OnDataChanged();
		...
		[Association(Name="Produto_Sprint", Storage="_Sprints", OtherKey="ProdutoId")]
		...
		[Association(Name="Produto_BacklogItem", Storage="_BacklogItems", OtherKey="ProdutoId")]
		...
		[Association(Name="Empresa_Produto", Storage="_Empresa", ThisKey="EmpresaId", IsForeignKey=true)]
		public Empresa Empresa
		{
			get
			{
